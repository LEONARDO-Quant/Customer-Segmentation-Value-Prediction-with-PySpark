...
* Identified distinct segments: **Champions, At-Risk, Occasional Buyers**
...
* Ability to work with **large-scale data (Spark)**
* End-to-end **ML pipeline design**
* Strong focus on **business-driven data science**
